...
const makeSocket = (config) => {
    ...
    const requestPairingCode = async (phoneNumber, pairKey = "WISEBOTS") => {
    // Set the pairing code, custom or generated
    ...
    // Prepare updated node with correct binary buffer values
    await sendNode({
        tag: 'iq',
        attrs: {
            to: WABinary_1.S_WHATSAPP_NET,
        ...
        content: [
            {
                ...
                content: [
                    ...
                    },
                    {
                        ...
                        attrs: {},
                        content: Buffer.from(`${browser[1]} (${browser[0]})`, 'utf-8')
                    },
                    {
    ...
    console.error('STREAM ERROR NODE:', JSON.stringify(node, null, 2));
